...
div
  ...
  template(v-if="modalShow")
    modal-input(v-model="modalShow", placeholder="请输入支付密码", title="支付密码", emptyMsg="请输入支付密码", type="password", :cb="inputChange", confirmText="提现")
...
export default {
  ...
  methods: {
    ...
    // 跳转提现进度
    jumpWithdraw () {
      this.logEventGet({ event: 'click_app_balance_withdraw', type: '01' })
