...
div
  ...
  div(style="margin-bottom: 60px")
    .bg-white.row.text-blue.padding-sm
      ...
      .text-gray(v-if="ladObject.status === '已完成'") {{ladObject.status}}
      .text-blue(v-else) {{ladObject.status}}
  ...
  .footer.row.bg-white.text-center.text-white.padding-sm(v-if="ladObject.status !== '已完成'")
