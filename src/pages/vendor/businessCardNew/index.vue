...
div
  ...
  .main.flex.mt-10
    .info.flex.flex-direction.justify-between
      .name.flex.flex-direction
  ...
  .card.border-radius-20
    .card-content
      .text-bold.ft-20.margin-bottom 公司介绍
      .ft-13.text-gray 江苏智恒达型云网络科技有限公司创建于2015年11月，坐落于长三角中心城市—江苏常州，依托华东地区特大的实体钢贸资源，自建型云钢铁电商平台（型云网www.xingyun361.com）以及配套供应链管理系统（ERP、WMS、）......
    .card-btn.ft-16.text-gray.border-top-line(@click="goCompanyInfo") 查看更多>
  .mask(v-if="isShare")
    .share
  ...
  .mask(v-if="isExchange")
    .exchange
      .top.flex.justify-center.align-center.bg-gray
        .ft-15.text-bold 交换名片
        .ft-14.text-gray.text-bold.top-close(@click="cancelExchange") 关闭
      ...
      .form.flex.flex-direction.justify-around.align-center
        ...
        .form-btn(@click="confirmExchange") 提交
...
.main
  ...
  margin-left 3%
  overflow hidden
  background-image url('http://xymobile.xingyun361.com/card-new-bg.png')
  background-size: 100% 429rpx;
